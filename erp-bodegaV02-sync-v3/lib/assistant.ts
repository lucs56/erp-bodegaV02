...
export function generalAssistantFallback(
  ...
  return "Esta pregunta necesita la IA general. Si aparece este mensaje, el ERP está usando el modo local porque OPENAI_API_KEY no está disponible o la conexión con la IA falló. Las consultas operativas de sincronización, stock, fichas técnicas y faltantes siguen funcionando localmente.";
}
