...
test("detecta altas, bajas y modificaciones",()=>{ const result=diffProgram([base,{...base,id:"b"}],[{...base,bottles:120},{...base,id:"c"}]); assert.deepEqual(result,{added:1,removed:1,modified:1,total:3}); });
